...
Ascension Training is a side-scrolling, infinite-level/time-trial arcade game where players control a heavy, unwieldy helicopter. The game focuses on balancing fuel, health, and ammunition while navigating obstacles and fighting enemies to progress through an endless series of levels with increasing difficulty.

## **1. Project Choice**

- **Option**: Web Game Design
- **Game Title**: “Ascension Training”
...
1. **Flight System**:
    ...
    - Players adjust the angle of ascent using the “A” and “D” keys, applying rotational force to the helicopter
    - A 2D physics engine simulates realistic gravitational pull, velocity, and acceleration for an immersive flight experience.

- Alternatively, through the mobile control scheme, pressing the left side of the screen rotates the helicopter left, pressing the right side of the screen rotates the helicopter right, and pressing both applies an upward force.
1. **Health System**:
...
- **Theme**: Retro-inspired arcade style with gritty, technical, pixelated graphics for a nostalgic feel.
- **Imagery**:
    ...
    - **HUD:** Bright green displays inspired by retro electronic aircraft HUD
...
- **Specification**: Use built-in Jolt Physics to implement realistic helicopter movement, gravity, and adjustable flight angles.
...
- **Specification**: Enemies aim based on the player’s position, with projectiles following a physics-based trajectory.
